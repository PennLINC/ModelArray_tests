...
cmd="convoxel --group-mask-file data_voxel_kristin_nback/n1601_NbackCoverageMask_20170427.nii.gz"
cmd+=" --cohort-file data_voxel_kristin_nback/XXXX.csv"
cmd+=" --relative-root /cbica/projects/fixel_db/dropbox"
cmd+=" --output-hdf5 data_voxel_kristin_nback/pncNback.h5"
